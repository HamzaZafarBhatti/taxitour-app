...
class DriverEndRequestController extends BaseController
{
  ...
  /*mail Template*/
        ...
        // $mail_template = MailTemplate::where('mail_type', 'invoice_maill')->first();

        // $description = $mail_template->description;

        // $pickup_address = $request_place->pickup_address; 
        // $dropoff_address = $request_place->drop_address;
        // $base_price = $request_detail->requestBill->base_price;
        // $additional_distance_price_per_Km = $request_detail->requestBill->additional_distance_price_per_Km;
        // $additional_time_price_per_min = $request_detail->requestBill->additional_time_price_per_min;
        // $waiting_Charge_per_minutes = $request_detail->requestBill->waiting_Charge_per_minutes;
        // $cancellation_fee = $request_detail->requestBill->cancellation_fee;
        // $service_tax = $request_detail->requestBill->service_tax;
        // $promo_discount = $request_detail->requestBill->promo_discount;
        // $admin_commision = $request_detail->requestBill->admin_commision;
        // $driver_commission = $request_detail->requestBill->driver_commission;
        // $total_amount = $request_detail->requestBill->total_amount;
        // $driver_name = $request_detail->driverDetail->name;
 
        // $app_name = get_settings('app_name');
               
        // $search = ['$user_name', '$pickup_address', '$dropoff_address', '$base_price','$additional_distance_price_per_Km', '$additional_time_price_per_min', '$waiting_Charge_per_minutes', '$cancellation_fee', '$service_tax', '$promo_discount', '$admin_commision', '$driver_commission', '$total_amount'];
        // $replace = [$user_name, $pickup_address, $dropoff_address, $base_price,$additional_distance_price_per_Km, $additional_time_price_per_min, $waiting_Charge_per_minutes, $cancellation_fee, $service_tax, $promo_discount, $admin_commision, $driver_commission, $total_amount];
